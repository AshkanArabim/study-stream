...
from rest_framework_simplejwt.tokens import AccessToken, RefreshToken  # Import both tokens
...
class VoteViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.note = Note.objects.create(title='Test Note', user=self.user, crn=123, class_date_and_time='2024-10-12T12:00:00Z')
        self.refresh_token = str(RefreshToken.for_user(self.user))  # Generate refresh token
        self.access_token = str(AccessToken.for_user(self.user))    # Generate access token
